...
<div class="page-wrap">
    <div class="glass-card">
        ...
        <p class="subtitle">Create your trainer account to access the portal and manage your profile.</p>

        <form action="/trainer/register" method="post">
            <div class="field">
                <label>ID</label>
        ...
        <div class="bottom-text">
            Already have an account? <a href="/trainer/login">Login here</a>
        </div>
    </div>
</div>
</body>
